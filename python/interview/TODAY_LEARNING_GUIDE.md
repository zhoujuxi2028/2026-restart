...
#
# Python自动化工程师面试复习计划（3天，每天3-4小时）

第1天：基础巩固与进阶
- 复习01-基础语法、02-数据结构，重点掌握变量、条件、循环、列表、字典、集合、元组等。
- 学习03-字符串操作、04-函数基础，熟悉字符串常用方法、函数定义与调用、参数类型、返回值。
- 练习常见算法题（如字符串反转、列表去重、字典合并等）。
- 阅读FAQ，整理常见面试问题及答案。

第2天：面向对象与异常处理
- 学习05-面向对象，掌握类、对象、继承、多态、封装等OOP概念。
- 学习07-异常处理，理解异常类型、try-except结构、异常自定义。
- 练习面向对象编程题（如设计类、实现继承与多态）。
- 阅读05-面试准备/面试题答案，模拟自我答题。

第3天：文件操作、模块与自动化实战
- 学习08-文件IO、09-模块与包，掌握文件读写、模块导入、包结构。
- 了解10-迭代器与生成器，掌握高效数据处理方式。
- 复习自动化相关实战项目（如Selenium、Postman、Cypress等目录下的案例）。
- 总结复习重点，查漏补缺，模拟面试自测。
